...
export const FightersBox = props => {
    ...
    return (
        <div className="row">
            <div className="col-md-5">{<FighterVersusBox fighter={fight.redAthlete} winner={redWon} corner="red" />}</div>
            <div className="col-md-2 text-center align-self-center">
                <DetailedVersus />
            </div>
            <div className="col-md-5">{<FighterVersusBox fighter={fight.blueAthlete} winner={blueWon} corner="blue" />}</div>
        </div>
    );
};
