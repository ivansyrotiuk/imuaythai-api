    ...
    return connectDragSource(
      <div className="row">
        <div className="col-md-auto">
          <UserAvatar size="50" name={ judgeRequest.user.firstname + ' ' + judgeRequest.user.surname } />
        </div>
        <div className="col">
          <div className="h4">
            { judgeRequest.user.firstname + ' ' + judgeRequest.user.surname }
          </div>
          <h6 className="card-subtitle mb-2 text-muted">{ judgeRequest.user.gymName || 'No gym' }, { judgeRequest.user.countryName }</h6>
        </div>
      </div>
