...
class ContestRequestsCard extends Component {
    constructor(props) {
        super(props);
              ...
              <div className="card">
                ...
                <div className="card-block">
                  <div className="col-12">
                    ...
                    <div className="btn btn-primary pull-right"><i className="fa fa-plus fa-1x" aria-hidden="true"> </i> Add</div>
                  </div>
                </div>
              </div>
            </div>
...
export default ContestRequestsCard