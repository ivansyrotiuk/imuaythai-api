...
class SecondStepRegister extends Component {
    render() {
        const {handleSubmit, pristine, reset, submitting, countries, roles, gyms, fetchingGyms, hasOwnGym, selectedGymRole, fetching, onCountryChange} = this.props;
...
SecondStepRegister = connect(state => {
