...
const RenderDatePicker = props => {
    return (
        <Datetime {...props.input} selected={props.input.value} dateFormat="DD-MM-YYYY" timeFormat="HH:mm" required/>
    );
};
                                ...
                                <Col className="col-md-6">
                                    <div className="form-group">
                                        ...
                                        <Field name="countryId" className="form-control" component="select"
                                               onChange={countryChange} required>
                        ...
                        <Col className="col-md-6">
                            <div className="form-group">
                                <div className="input-group">
                                    ...
                                    <Field name="instagram" component="input" className="form-control"
                                           type="text"
                        ...
                        <Col className="col-md-6">
                            <div className="form-group">
                                ...
                                <div className="input-group">
                                    ...
                                    <Field name="twitter" component="input" className="form-control"
                                           type="input"
