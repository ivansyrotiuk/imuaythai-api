...
class Login extends Component {
  render() {
    ...
    const loadingButton = <a class="btn btn-primary px-4" disabled={ fetching || submitting }>
                            <i class="fa fa-spinner fa-pulse fa-1x fa-fw"></i> Login
                          </a>;
                          ...
                          <div className="col-6 text-right center-block">
                            <div class="form-check">
                              <label class="form-check-label">
                                <Field name="rememberme" component="input" type="checkbox" class="form-check-input" /> Remember me?
                              </label>
                            </div>
                          </div>
                        </div>
