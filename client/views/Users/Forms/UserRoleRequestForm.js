                            ...
                            <div className="card-block">
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <button
                                        ...
                                        className="btn btn-sm btn-primary pull-right">{submitting && <i class="fa fa-spinner fa-pulse fa-1x fa-fw"></i>}
                                        Save</button>
...
export default reduxForm({form: 'UserRolesForm'})(UserRolesForm);
