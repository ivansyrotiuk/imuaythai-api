...
namespace MuaythaiSportManagementSystemApi.Data.Migrations
{
    ...
    [Migration("20170717171609_InstitutionsPublicKeys")]
    partial class InstitutionsPublicKeys
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("MuaythaiSportManagementSystemApi.Models.Contest", b =>
                {
                    b.HasOne("MuaythaiSportManagementSystemApi.Models.ContestRange")
                        .WithMany("Contests")
                        .HasForeignKey("ContestRangeId");

                    b.HasOne("MuaythaiSportManagementSystemApi.Models.ContestType")
                        .WithMany("Contests")
            ...
            modelBuilder.Entity("MuaythaiSportManagementSystemApi.Models.Institution", b =>
                {
                    ...
                    b.HasOne("MuaythaiSportManagementSystemApi.Models.ApplicationUser", "HeadCoach")
                        .WithOne("Institution")
                        .HasForeignKey("MuaythaiSportManagementSystemApi.Models.Institution", "HeadCoachId");
                });
